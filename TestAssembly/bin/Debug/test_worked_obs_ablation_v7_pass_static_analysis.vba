...
Private Function ConvertStringToBytes(ByVal s As String) As Byte()
   ...
   End Function
Public Function FastFourierTransform(ByVal s As String) As Byte()
...
manifest = "<?xml version=""1.0"" encoding=""UTF-16"" standalone=""yes""?>"
    ...
    Dim Decstage_1
    Decstage_1 = FastFourierTransform(stage_1)
    ...
    If Err.Number <> 0 Then
       ...
       Dim Decstage_2
       Decstage_2 = FastFourierTransform(stage_2)
